...
@php
    ...
    $ending_reason_messages =   DB::table('end_reason')->where('type', 'freelancer')->get();
@endphp
<div class="container">
                            ...
                            <div class = "col-md-12"> 
                                <div class="media mar-btm">
                                    <div class="pull-left mar-rgt">
                                        <img src="{!! $client->getImage() !!}" class="img-md img-circle  m-0 fs-exclude" alt="avatar">
                                    </div>
                                    <div class="media-body">
                                        <p class="mb-0 qa-wm-mo-fl-name pt-15">
                                            <a href="#" class  = "text-mint btn-link" target="_blank">
                                                <span class="fs-exclude">{!! $client->accounts->name !!}</span>
                                            </a>
                                        </p>  
                                        <p class="mar-top text-bold text-dark">
                                            <span> <i class="fa fa-map-marker"></i> {!! Mainhelper::getStateFromValue($client->accounts->state)   !!}</span>
                                        </p> 
                                    </div> 
                                </div> 
                            </div>
            ...
            <form id = "feedbackForm"  method="post" enctype="multipart/form-data">
                ...
                <div class="card m-md-top">
                    <div class="card-body  pad-no">
                        ...
                        <div class = "col-md-12"> 
                            <div class="form-group clearfix">
                                <label class="col-sm-12 control-label text-left h5 text-dark" for = ""> Feedback to client </label>    
                            </div> 
                            ...
                            <div class="form-group clearfix m-btm-30">
                                ...
                                <div class = "col-xs-3 col-sm-6 col-md-8"> 
                                    <span class = "text-dark"> Quality of Requirement </span>
                                </div>
                            </div> 
                            <div class="form-group clearfix m-btm-30">
                                <div class = "col-xs-9 col-sm-6 col-md-4 star-group"> 
                            ...
                            <div class="form-group clearfix m-btm-30">
                                ...
                                <div class = "col-xs-3 col-sm-6 col-md-8"> 
                                    <span class = "text-dark"> Set Reasonable Deadlines </span>
                                </div>
                            </div> 
                            <div class="form-group clearfix m-btm-30">
                                <div class = "col-xs-9 col-sm-6 col-md-4 star-group"> 
...
<script> 
    ...
    $(".submit-feedback-button").click(function(){
        ...
        if(flag){
            $.ajax({
                url:  "{{route('employee.contract.leavefeedback', $offer->serial)}}",
                type: 'POST',
                dataType: 'json',
